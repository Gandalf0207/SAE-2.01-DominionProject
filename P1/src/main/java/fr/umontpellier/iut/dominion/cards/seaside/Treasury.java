...
public class Treasury extends Card {
    ...
    public void treasuryEffect(Player p){
        ...
        l.add(new Button("Mettre dans la pioche", "y"));
        l.add(new Button("Défausse", "n"));
        if ("y".equals(p.chooseStringFromButtons("Votre carte sera mis au dessus de la pioche", l, false))) {
            p.moveToDraw(this);
        }
        else {
