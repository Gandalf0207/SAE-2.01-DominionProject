...
Le fichier [IO.md](https://gitlabinfo.iutmontp.univ-montp2.fr/dev-objets/projets/dominion-seaside/-/blob/main/IO.md) contient des précisions sur les entrées/sorties attendues avec des exemples et des détails pour chacune des cartes à écrire :
...
Pensez à consulter régulièrement les [FAQ](https://gitlabinfo.iutmontp.univ-montp2.fr/dev-objets/projets/dominion-seaside/-/blob/main/FAQ.md). Vous serez informés s'il y a des nouveautés (surveillez le [Forum Piazza](https://piazza.com/umontpellier.fr/spring2026/devobjets/)).
