...
public class DominionIHM extends Application {
    ...
    public void startGame() {
        ...
        Scene scene = new Scene(gameView, Screen.getPrimary().getBounds().getWidth() * screenRatio,  Screen.getPrimary().getBounds().getHeight() * screenRatio); // la scene doit être créée avant de mettre en place les bindings
        game.run();

        ScoresView scoresView = new ScoresView(this); // peut-être utilisée pour afficher les scores à la fin de la partie
...
//        String[] kingdomCards = new String[]{"Embargo", "Island", "Native Village", "Navigator", "Lookout", "Lighthouse", "Pirate", "Pearl Diver", "Pirate Ship", "Ghost Ship"};
